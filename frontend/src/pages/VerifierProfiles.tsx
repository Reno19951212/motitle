...
// v5-A3 — Verifier Profile CRUD page (NEW LLM-as-judge entity). Smallest of
// the 5 v5 profile pages: name, lang (source audio language), llm_profile_id,
// prompt_template_id.
...
export default function VerifierProfiles() {
  ...
  async function refresh() {
    try {
      ...
      console.error('Failed to load verifier profiles', e);
    }
  }

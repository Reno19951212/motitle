...
Endpoints (all login_required):
  GET    /api/llm_profiles               List visible (owner OR admin OR shared)
  POST   /api/llm_profiles               Create (current user is owner)
  GET    /api/llm_profiles/<pid>         View single (admin OR owner OR shared)
  PATCH  /api/llm_profiles/<pid>         Update (admin OR owner only)
  DELETE /api/llm_profiles/<pid>         Delete (admin OR owner only)

...
def reset_managers(tmp_path):
    """Reinitialize _glossary_manager with a fresh tmp_path before each test so
    state left by other test files doesn't cause failures."""
    from app import _init_glossary_manager
